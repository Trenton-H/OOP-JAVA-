...
public class ParallelSortTester {
    ...
    public static void runSortTester() {
        ...
        int usingProcessors = 1;
        
        //outer loop tells ultimate function how many threads to use
        for(int j = usingProcessors; j <= processors; j*=2)
        {
            //inner loop provides the size of the numbers to sort
            System.out.println(j + " Thread:");
            for(int i = LENGTH; i <=16384000; i*=2) //16384000 //8192000
            {
                Integer[] a = createRandomArray(i);
                ...
                ParallelMergeSorter.sort(a, j, comp);
